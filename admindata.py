...
class Logueados:
    ...
    def __init__(self):
        ...
        self.mensajes = pd.DataFrame(columns=["detinatario", "user", "mensaje"])
    ...
    def registrar_mensaje(self, user, mensaje, destinatarios):
        for destino in destinatarios:
            nueva_fila = pd.Series({'detinatario': destino, 'user': user, 'mensaje': mensaje})
    ...
    def recibir_mensajes(self, user):
        # TODO
        return [["TODO", "Funcionalidad no implementada"]]
...
if __name__ == '__main__':
    # pruebas unitarias clase Registrados
